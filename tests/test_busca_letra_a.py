...
def test_contagem_letra_a_com_varias_a():
    assert contagem_letra_a("Ana tem uma árvore à beira da estrada.") == 9, "Deve contar corretamente as variações de 'a'"

def test_contagem_letra_a_com_caracteres_especiais():
    assert contagem_letra_a("@b@c@d@ e#f$g% ^&*(") == 0, "Caracteres especiais não devem afetar a contagem de 'a'"
